      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-6 pb-20">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex-1 py-2 lg:pr-12 min-w-0 overflow-hidden">
            ...
            <SitePreview images={["/NeuralWeb.png", "/Neuralwebsite.png"]} url="https://www.neuralarc.ai" alt="NeuralArc website preview" />
          ...
          <div className="flex-1 py-2 lg:pl-12 min-w-0 overflow-hidden">
            ...
            <SitePreview images={["/Product/Pro.png", "/Product/Pro2.png", "/Product/Pro3.png", "/Product/pro4.png", "/Product/pro5.png", "/Product/pro6.png", "/Product/pro7.png"]} url="https://he2.ai" alt="Helium AI product preview" />
